...
from auto_LiRPA.preimage_optimize_input_poly import concretize_poly_vol,concretize_poly_vol_LSE
...
def backward_general(
        ...
        need_A_only=False, unstable_idx=None, unstable_size=0, update_mask=None, verbose=True, opt_input_poly=False, trans=False):
    if verbose:
    ...
    if self.return_A and (not opt_input_poly):
