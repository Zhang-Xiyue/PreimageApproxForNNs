...
class ConfigHandler:
    ...
    def add_common_options(self):
        ...
        # NOTE to check the effect of sample size for local optimization    
        self.add_argument("--sample_optim", type=int, default=1000,
                          help='Sample size for local optimization.', hierarchy=h + ["sample_optim"])
        self.add_argument("--approx_tp", type=str, default='over',
                          help='Generate over- or under-approximation.', hierarchy=h + ["approx_tp"])
        ...
        self.add_argument("--root_path", type=str, default='/home/xiyue/LinInv/vnncomp2022_benchmarks/benchmarks/mnist_fc',
                          help='Root path of VNN-COMP benchmarks folder (VNN-COMP specific).',
                          hierarchy=h + ["root_path"])

        h = ["model"]
        # self.add_argument('--vcas', type=int, default=1, help="Index of models for VCAS classification problem.", hierarchy=h + ["vcas"])  
